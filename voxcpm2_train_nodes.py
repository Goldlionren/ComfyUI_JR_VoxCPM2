...
try:
    ...
    TRAINING_IMPORT_ERROR = f"{type(e).__name__}: {e}"
...
class VoxCPM_TrainConfig(io.ComfyNode):
    ...
    def define_schema(cls) -> io.Schema:
        return io.Schema(
            node_id="VoxCPM2_TrainConfig",
            display_name="VoxCPM2 Train Config",
            ...
            inputs=[
                ...
                io.Int.Input("sample_rate", default=16000, min=16000, max=48000, tooltip="Sample rate must match AudioVAE encoder (16000 for VoxCPM2)."),
...
class VoxCPM_DatasetMaker(io.ComfyNode):
    ...
    def define_schema(cls) -> io.Schema:
        return io.Schema(
            node_id="VoxCPM2_DatasetMaker",
            display_name="VoxCPM2 Dataset Maker",
            category=cls.CATEGORY,
...
class VoxCPM_LoraTrainer(io.ComfyNode):
    ...
    def define_schema(cls) -> io.Schema:
        ...
        return io.Schema(
            node_id="VoxCPM2_LoraTrainer",
            display_name="VoxCPM2 LoRA Trainer",
            category=cls.CATEGORY,
